        ...
        {projects.map((project, index) => (
          <div key={index}>
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="rounded-lg bg-lightL dark:bg-backgroundL  lg:w-1/2 p-8  hover:shadow-lg shadow-cyan-500/50 transition-shadow">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.techStack.map((tech, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 text-sm bg-backgroundL dark:bg-backgroundL rounded-full"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex gap-4">
                  {project.github && (
                    <Link
                      href={project.github}
                      target="_blank"
                      className="text-contrastL dark:text-contrastL hover:text-textL dark:hover:text-textL"
                    >
                      GitHub →
                    </Link>
                  )}
